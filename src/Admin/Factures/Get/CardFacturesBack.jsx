const CardFacturesBack = ({ factura, clientes, empleados }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-4 min-w-[300px] min-h-[150px] flex flex-col justify-start overflow-hidden">
