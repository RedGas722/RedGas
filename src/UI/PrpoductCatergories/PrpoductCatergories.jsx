...
export const PrpoductCatergories = ({imgCategory, nameCategory, className, onClick}) => {
	return(
        <div tabIndex='0' onClick={onClick} className="cardCategory NeoSubContainer_outset_TL flex justify-center text-[var(--main-color)] items-center gap-[20px] !rounded-[10px] hover:!rounded-[16px] shadow_box cursor-pointer hover:text-[var(--Font-Nav)]">
